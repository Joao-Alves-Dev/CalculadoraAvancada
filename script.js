...
function changeLanguage(language) {
    ...
    document.querySelector('.btn-clear-history').innerText = translations[language].clearHistory;
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    changeLanguage('en'); // Mude para 'pt' se quiser o padrão em português
});
...
function toggleMenu() {
    ...
    menuToggle.classList.toggle('minimized');
